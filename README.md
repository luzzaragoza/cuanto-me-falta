...
- **Dashboard**: porcentaje aprobado, conteos, barra de progreso y los títulos intermedios (Analista, Licenciado, Ingeniero) con cuántas materias faltan para cada uno.
...
Un único archivo `index.html` (HTML + CSS + JavaScript, sin dependencias más allá de las tipografías de Google Fonts). Se puede hostear directo en GitHub Pages.
