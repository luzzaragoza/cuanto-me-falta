...
**Debilidad conocida:** un test —el del interruptor de año— falla aproximadamente **una de cada tres corridas de la suite completa** y pasa siempre aislado. Es flakiness del runner en paralelo, no una rotura del código, pero en CI bloquea merges al azar y está anotado para arreglar. Un test que falla a veces enseña a ignorar los rojos, que es peor que no tenerlo.
