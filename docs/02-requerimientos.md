...
| RN-14 | En reposo, el árbol dibuja únicamente las correlativas **cortas** (las que separan **uno o dos cuatrimestres**: el 83 % del total). Una correlativa se dibuja **solo si puede rutearse sin cruzar ninguna materia**: las que no encuentran paso limpio, y las largas, se muestran al entrar en modo rama. La malla nunca prioriza mostrar todo por encima de leerse. |
